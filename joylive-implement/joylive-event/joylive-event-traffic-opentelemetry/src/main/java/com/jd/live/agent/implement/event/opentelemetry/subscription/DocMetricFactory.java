...
public class DocMetricFactory implements MetricFactory<DocEvent> {

    @Override
    public Subscription<DocEvent> create(ExporterConfig config, Application application, Meter meter) {
        return new DocMetric(application, meter);
    }
}
