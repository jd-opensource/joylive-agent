 ...
 */
package com.jd.live.agent.implement.bean.mcp.web.javax;
...
import com.jd.live.agent.implement.bean.mcp.web.AbstractMcpController;
import com.jd.live.agent.implement.bean.mcp.web.SseEmitterMcpTransport;
...
/**
 * Javax Servlet API implementation of MCP controller.
 * Handles JSON-RPC requests using Javax Servlet API.
 */
@RestController
