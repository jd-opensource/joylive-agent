...
public class Swagger2Factory extends SwaggerFactory {
     ...
     */
    protected ExternalDoc buildExternalDoc(ExternalDocs doc) {
        if (doc == null) {
            return null;
        }
     ...
     */
    protected PathItem buildPathItem(Swagger swagger, Path pathItem, ContentTypes defaults) {
        if (pathItem == null) {
            return null;
     ...
     */
    protected ApiResponse buildApiResponse(Response response, ContentTypes types) {
        if (response == null) {
            return null;
        }
     ...
     */
    protected Header buildHeader(Property property) {
        if (property == null) {
            return null;
        }
    ...
    protected SecurityScheme buildSecurityScheme(ApiKeyAuthDefinition definition) {
        if (definition == null) {
            return null;
        }
    ...
    protected SecurityScheme buildSecurityScheme(BasicAuthDefinition definition) {
        if (definition == null) {
            return null;
        }
        return SecurityScheme.builder()
    ...
    protected SecurityScheme buildSecurityScheme(OAuth2Definition definition) {
        if (definition == null) {
            return null;
        }
     ...
     */
    protected RequestBody buildRequestBody(BodyParameter parameter, ContentTypes contentTypes) {
        if (parameter == null) {
            return null;
        }
     ...
     */
    protected RequestBody buildRequestBody(RefParameter parameter, ContentTypes contentTypes) {
        if (parameter == null) {
            return null;
        }
     ...
     */
    protected RequestBody buildRequestBody(List<FormParameter> parameters, ContentTypes contentTypes) {
        if (parameters == null) {
            return null;
        }
        List<String> mediaTypes = contentTypes.consumes == null || contentTypes.consumes.isEmpty()
     ...
     */
    protected Schema buildSchema(SerializableParameter parameter) {
    ...
    protected Schema buildSchema(RefModel model) {
    ...
    protected Schema buildSchema(ArrayModel model) {
    ...
    protected Schema buildSchema(ComposedModel model) {
        return builder(model).allOf(toList(model.getAllOf(), this::buildSchema)).build();
    }

    protected Schema buildSchema(ModelImpl model) {
    ...
    protected Schema buildSchema(Property property) {
        if (property == null) {
            return null;
     ...
     * @return schema builder
     */
    protected Schema.SchemaBuilder builder(Model model) {
        Schema.SchemaBuilder builder = Schema.builder()
     ...
     */
    protected String getRef(Swagger swagger, RefParameter parameter) {
