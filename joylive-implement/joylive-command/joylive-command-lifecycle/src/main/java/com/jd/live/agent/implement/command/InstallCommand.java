...
@Extension(Command.CMD_INSTALL_PLUGIN)
public class InstallCommand implements Command {
    ...
    public InstallCommand(PluginSupervisor pluginSupervisor) {
    ...
    public void execute(Map<String, Object> args) {
        ...
        if (config != null && !config.isEmpty()) {
            pluginSupervisor.install(new HashSet<>(Arrays.asList(StringUtils.split(config, ','))));
        }
    }
}
