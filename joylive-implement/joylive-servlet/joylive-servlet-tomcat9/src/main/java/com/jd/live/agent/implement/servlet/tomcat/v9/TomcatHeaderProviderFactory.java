...
@ConditionalOnType(TomcatHeaderProviderFactory.TYPE_JAVAX_SERVLET_REQUEST)
public class TomcatHeaderProviderFactory implements HeaderProviderFactory {
    ...
    protected static final String TYPE_JAVAX_SERVLET_REQUEST = "javax.servlet.http.HttpServletRequest";
