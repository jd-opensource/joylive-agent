...
1. 重构了注册模块，更好的支持多注册和多订阅
2. 新增支持多活场景下Zookeeper集群故障进行主备集群切换
3. 新增支持多活场景下数据库保护及分区故障进行主备集群切换
4. 新增支持多活场景下Rocketmq分区故障进行主备集群切换
5. 新增支持传统Springboot应用转化为微服务应用时对依赖服务进行预热
6. 新增支持XMLPath和JavaPath来提取异常错误码，用于熔断和重试的异常判断
7. 完善Dubbo的支持
8. 完善消息的多活路由
9. 修复其它问题
