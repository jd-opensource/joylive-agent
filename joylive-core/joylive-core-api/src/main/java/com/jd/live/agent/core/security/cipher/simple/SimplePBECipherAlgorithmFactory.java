...
@Extension("SimplePBE")
public class SimplePBECipherAlgorithmFactory implements CipherAlgorithmFactory {

    private static final Logger logger = LoggerFactory.getLogger(SimplePBECipherAlgorithmFactory.class);
    ...
    public CipherAlgorithm create(CipherAlgorithmContext ctx) {
        ...
        return new SimplePBECipherAlgorithm(ctx);
    }
}
