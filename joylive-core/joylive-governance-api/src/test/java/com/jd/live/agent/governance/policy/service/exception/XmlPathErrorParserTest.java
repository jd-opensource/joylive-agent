...
import com.jd.live.agent.governance.policy.service.exception.xml.XmlPathErrorParser;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.Test;

public class XmlPathErrorParserTest {
    ...
    void testParse() {
        String response = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" +
                ...
                "</errorResponse>";
        XmlPathErrorParser errorParser = new XmlPathErrorParser(new JdkXmlPathParser());
        Assertions.assertEquals("404", errorParser.getValue("//status/text()", response));
    }
}
