 ...
 */
package com.jd.live.agent.governance.policy.service.health;
...
@Setter
@Consumer
public class HealthPolicy extends PolicyId implements PolicyInheritWithId<HealthPolicy> {

    private Integer healthyMinPercent;

    @Override
    public void supplement(HealthPolicy source) {
        if (healthyMinPercent == null && source != null) {
