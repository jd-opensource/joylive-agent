...
/**
 * Represents an actual physical database connection.
 * Wraps a raw JDBC connection with tracking and cluster awareness.
 */
public class DriverConnection extends AbstractConnection {
