...
@Extension(value = "PrimitiveFloatArraySupplier", order = 1)
public class PrimitiveFloatArrayBuilder implements ArrayBuilder {
    ...
    public ArrayObject create(Object array) {
        return new PrimitiveFloatArray((float[]) array);
    }
