...
@Extension(value = "PrimitiveDoubleArraySupplier", order = 1)
public class PrimitiveDoubleArrayBuilder implements ArrayBuilder {
    ...
    public ArrayObject create(Object array) {
        return new PrimitiveDoubleArray((double[]) array);
    }
