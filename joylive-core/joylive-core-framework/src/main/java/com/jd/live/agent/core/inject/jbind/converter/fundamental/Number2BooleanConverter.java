...
@Extension("Number2BooleanConverter")
public class Number2BooleanConverter extends BooleanConverter {
    @Override
    public Object convert(Conversion conversion) {
        Object source = conversion.getSource();
        return source == null ? null : ((Number) source).intValue() != 0 ? Boolean.TRUE : Boolean.FALSE;
    }
