...
/**
 * JExtensionMapSourcer
 *
 * @since 1.0.0
 */
public class JExtensionMapSourcer extends JExtensibleSourcer {

    public JExtensionMapSourcer(String name, Class<?> type, Class<?> owner, ResourcerType resourcerType) {
    ...
    public Object getSource(Object context) {
        ...
        return extensible == null ? null : extensible.getExtensionMap();
    }
