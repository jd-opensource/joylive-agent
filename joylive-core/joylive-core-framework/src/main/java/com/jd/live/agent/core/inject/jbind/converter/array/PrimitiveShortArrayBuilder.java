...
@Extension(value = "PrimitiveShortArraySupplier", order = 1)
public class PrimitiveShortArrayBuilder implements ArrayBuilder {
    ...
    public ArrayObject create(Object array) {
        return new PrimitiveShortArray((short[]) array);
    }
