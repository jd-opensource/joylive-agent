...
@Extension(value = "PrimitiveLongArraySupplier", order = 1)
public class PrimitiveLongArrayBuilder implements ArrayBuilder {
    ...
    public ArrayObject create(Object array) {
        return new PrimitiveLongArray((long[]) array);
    }
