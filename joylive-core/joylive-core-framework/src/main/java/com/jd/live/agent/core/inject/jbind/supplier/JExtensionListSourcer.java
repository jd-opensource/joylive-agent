 ...
 * @since 1.0.0
 */
public class JExtensionListSourcer extends JExtensibleSourcer {

    public JExtensionListSourcer(String name, Class<?> type, Class<?> owner, ResourcerType resourcerType) {
    ...
    public Object getSource(Object context) {
        ...
        return extensible == null ? null : extensible.getExtensions();
    }
