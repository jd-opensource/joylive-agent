...
@Extension(value = "PrimitiveBooleanArraySupplier", order = 1)
public class PrimitiveBooleanArrayBuilder implements ArrayBuilder {
    ...
    public ArrayObject create(Object array) {
        return new PrimitiveBooleanArray((boolean[]) array);
    }
