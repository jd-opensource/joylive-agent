 ...
 */
public class LiveHikariDataSource implements LiveDataSource {
    ...
    public LiveHikariDataSource(HikariDataSource dataSource, DbUrl dbUrl) {
    ...
    public void discard(Connection connection) {
        if (connection instanceof HikariPoolConnection) {
            HikariPoolConnection hikariConnection = (HikariPoolConnection) connection;
