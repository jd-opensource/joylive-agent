...
import com.jd.live.agent.plugin.protection.jedis.v4.interceptor.JedisClusterProtectInterceptor;

@Injectable
@Extension(value = "JedisClusterProtectDefinition_v4", order = PluginDefinition.ORDER_FAILOVER)
