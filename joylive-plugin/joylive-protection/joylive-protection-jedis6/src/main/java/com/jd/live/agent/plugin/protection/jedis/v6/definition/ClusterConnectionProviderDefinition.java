...
import com.jd.live.agent.plugin.protection.jedis.v6.interceptor.ClusterConnectionProviderInterceptor;

@Injectable
@Extension(value = "ClusterConnectionProviderDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
