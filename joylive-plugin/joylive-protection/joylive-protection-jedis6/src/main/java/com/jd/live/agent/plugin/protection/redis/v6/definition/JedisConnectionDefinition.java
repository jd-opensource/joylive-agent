 ...
 */
package com.jd.live.agent.plugin.protection.redis.v6.definition;
...
import com.jd.live.agent.plugin.protection.redis.v6.condition.ConditionalOnProtectJedis6Enabled;
import com.jd.live.agent.plugin.protection.redis.v6.interceptor.JedisConnectionInterceptor;

@Injectable
@Extension(value = "JedisConnectionDefinition_v6", order = PluginDefinition.ORDER_PROTECT)
