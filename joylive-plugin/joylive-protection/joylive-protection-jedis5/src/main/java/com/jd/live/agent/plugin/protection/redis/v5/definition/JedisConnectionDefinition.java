 ...
 */
package com.jd.live.agent.plugin.protection.redis.v5.definition;
...
import com.jd.live.agent.plugin.protection.redis.v5.condition.ConditionalOnProtectJedis5Enabled;
import com.jd.live.agent.plugin.protection.redis.v5.interceptor.JedisConnectionInterceptor;

@Injectable
@Extension(value = "JedisConnectionDefinition_v5", order = PluginDefinition.ORDER_PROTECT)
