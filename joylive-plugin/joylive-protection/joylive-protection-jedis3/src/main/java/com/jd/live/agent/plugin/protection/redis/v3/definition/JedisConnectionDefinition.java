 ...
 */
package com.jd.live.agent.plugin.protection.redis.v3.definition;
...
import com.jd.live.agent.plugin.protection.redis.v3.condition.ConditionalOnProtectJedis3Enabled;
import com.jd.live.agent.plugin.protection.redis.v3.interceptor.JedisConnectionInterceptor;

@Injectable
@Extension(value = "JedisConnectionDefinition_v3", order = PluginDefinition.ORDER_PROTECT)
