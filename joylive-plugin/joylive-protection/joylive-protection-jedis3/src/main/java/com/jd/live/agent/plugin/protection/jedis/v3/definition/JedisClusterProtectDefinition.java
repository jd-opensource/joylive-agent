 ...
 */
package com.jd.live.agent.plugin.protection.jedis.v3.definition;
...
import com.jd.live.agent.plugin.protection.jedis.v3.interceptor.JedisClusterProtectInterceptor;

@Injectable
@Extension(value = "JedisClusterProtectDefinition_v3", order = PluginDefinition.ORDER_FAILOVER)
