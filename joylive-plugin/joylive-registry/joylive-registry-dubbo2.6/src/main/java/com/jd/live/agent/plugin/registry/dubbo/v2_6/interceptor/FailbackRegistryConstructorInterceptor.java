...
import com.jd.live.agent.plugin.registry.dubbo.v2_6.registry.DubboRegistryService;
...
public class FailbackRegistryConstructorInterceptor extends InterceptorAdaptor {
    ...
    public void onSuccess(ExecutableContext ctx) {
        ...
        ExecutorService executor = getQuietly(registry, FIELD_REGISTRY_CACHE_EXECUTOR);
        if (executor != null) {
