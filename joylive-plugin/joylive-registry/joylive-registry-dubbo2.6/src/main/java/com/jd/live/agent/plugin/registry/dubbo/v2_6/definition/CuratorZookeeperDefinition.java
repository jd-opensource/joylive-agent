...
import com.jd.live.agent.plugin.registry.dubbo.v2_6.interceptor.CuratorZookeeperInterceptor;

/**
 * CuratorZookeeperDefinition
 */
@Injectable
@Extension(value = "CuratorZookeeperDefinition_v2.6", order = PluginDefinition.ORDER_REGISTRY)
@ConditionalOnDubbo26GovernanceEnabled
@ConditionalOnClass(CuratorZookeeperDefinition.TYPE)
public class CuratorZookeeperDefinition extends PluginDefinitionAdapter {

    protected static final String TYPE = "com.alibaba.dubbo.remoting.zookeeper.curator.CuratorZookeeperTransporter";
