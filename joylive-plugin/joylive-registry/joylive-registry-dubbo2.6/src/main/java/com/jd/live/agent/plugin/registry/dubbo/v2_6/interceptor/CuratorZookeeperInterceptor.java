...
import com.jd.live.agent.plugin.registry.dubbo.v2_6.zookeeper.CuratorFailoverClient;

/**
 * CuratorZookeeperInterceptor
 */
public class CuratorZookeeperInterceptor extends InterceptorAdaptor {

    private final Timer timer;

    private final HealthProbe probe;

    public CuratorZookeeperInterceptor(Timer timer, HealthProbe probe) {
        this.timer = timer;
        this.probe = probe;
    }
