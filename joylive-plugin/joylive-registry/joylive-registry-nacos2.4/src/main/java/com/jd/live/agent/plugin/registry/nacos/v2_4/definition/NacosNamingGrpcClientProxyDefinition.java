...
import com.jd.live.agent.plugin.registry.nacos.v2_4.interceptor.NacosNamingGrpcClientProxyInterceptor;
 ...
 */
@Injectable
@Extension(value = "NacosNamingGrpcClientProxyDefinition_v2.4", order = PluginDefinition.ORDER_REGISTRY)
