...
import com.jd.live.agent.plugin.registry.springcloud.v2_1.interceptor.FeignClientFactoryBeanInterceptor;

/**
 * FeignClientFactoryBeanDefinition
 */
@Injectable
@Extension(value = "FeignClientFactoryBeanDefinition_v2.1", order = PluginDefinition.ORDER_REGISTRY)
