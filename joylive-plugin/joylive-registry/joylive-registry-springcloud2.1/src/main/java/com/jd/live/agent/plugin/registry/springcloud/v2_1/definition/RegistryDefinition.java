...
import com.jd.live.agent.plugin.registry.springcloud.v2_1.interceptor.RegistryInterceptor;

/**
 * RegistryDefinition
 */
@Injectable
@Extension(value = "ServiceRegistryDefinition_v2.1", order = PluginDefinition.ORDER_REGISTRY)
