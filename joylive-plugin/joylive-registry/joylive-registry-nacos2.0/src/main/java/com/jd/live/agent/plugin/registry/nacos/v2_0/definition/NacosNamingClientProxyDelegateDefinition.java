...
import com.jd.live.agent.plugin.registry.nacos.v2_0.interceptor.NacosNamingClientProxyDelegateInterceptor;
 ...
 *
 * <p>The plugin targets Nacos 2.0.x versions and intercepts the constructor
 * of NamingClientProxyDelegate to inject custom notification capabilities.</p>
 */
@Injectable
@Extension(value = "NacosNamingClientProxyDelegateDefinition_v2.0", order = PluginDefinition.ORDER_REGISTRY)
