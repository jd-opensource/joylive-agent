...
import com.jd.live.agent.plugin.registry.nacos.v2_0.interceptor.NacosInstancesChangeNotifierInterceptor;

/**
 * NacosInstanceChangeDefinition
 */
@Injectable
@Extension(value = "NacosInstanceChangeDefinition_v2.0", order = PluginDefinition.ORDER_REGISTRY)
