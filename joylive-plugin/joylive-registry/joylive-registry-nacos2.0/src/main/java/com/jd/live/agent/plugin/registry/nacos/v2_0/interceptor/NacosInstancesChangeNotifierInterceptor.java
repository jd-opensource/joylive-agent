...
import com.jd.live.agent.plugin.registry.nacos.v2_0.registry.NacosInstancesChangeNotifier;
...
public class NacosInstancesChangeNotifierInterceptor extends InterceptorAdaptor {
    ...
    public void onSuccess(ExecutableContext ctx) {
        ...
        if (publisher != null) {
            ...
            publisher.setNotifier(new NacosInstancesChangeNotifier(notifier, publisher.getPublisher()));
