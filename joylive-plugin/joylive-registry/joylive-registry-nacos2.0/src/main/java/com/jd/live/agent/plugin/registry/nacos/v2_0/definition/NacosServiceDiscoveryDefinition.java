...
import com.jd.live.agent.plugin.registry.nacos.v2_0.interceptor.NacosDiscoveryConstructorInterceptor;
import com.jd.live.agent.plugin.registry.nacos.v2_0.interceptor.NacosDiscoveryInstanceInterceptor;

/**
 * NacosServiceDiscoveryDefinition
 */
@Extension(value = "NacosServiceDiscoveryDefinition_v2.0", order = PluginDefinition.ORDER_REGISTRY)
