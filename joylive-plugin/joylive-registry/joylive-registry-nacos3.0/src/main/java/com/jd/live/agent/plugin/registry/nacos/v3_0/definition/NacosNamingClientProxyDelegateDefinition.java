 ...
 *
 * <p>The plugin targets Nacos 3.0.x versions and intercepts the constructor
 * of NamingClientProxyDelegate to inject custom notification capabilities.</p>
 */
@Injectable
@Extension(value = "NacosNamingClientProxyDelegateDefinition_v3.0", order = PluginDefinition.ORDER_REGISTRY)
