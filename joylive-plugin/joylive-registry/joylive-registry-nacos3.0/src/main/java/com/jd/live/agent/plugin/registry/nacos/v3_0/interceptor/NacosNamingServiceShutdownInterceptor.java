...
import com.jd.live.agent.plugin.registry.nacos.v3_0.registry.NacosRegistryService;
...
public class NacosNamingServiceShutdownInterceptor extends InterceptorAdaptor {
    ...
    public void onEnter(ExecutableContext ctx) {
        ...
        InstancesChangeNotifier changeNotifier = getQuietly(client, "changeNotifier");
