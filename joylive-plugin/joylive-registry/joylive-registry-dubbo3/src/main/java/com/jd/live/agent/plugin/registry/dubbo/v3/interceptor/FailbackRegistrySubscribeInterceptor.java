...
import com.jd.live.agent.plugin.registry.dubbo.v3.registry.DubboNotifyListener;
import com.jd.live.agent.plugin.registry.dubbo.v3.registry.DubboRegistryPublisher;
...
public class FailbackRegistrySubscribeInterceptor extends InterceptorAdaptor {
    ...
    public void onEnter(ExecutableContext ctx) {
        ...
        if (CONSUMER_PROTOCOL.equals(url.getProtocol())) {
            ScheduledExecutorService executor = getQuietly(target, FIELD_REGISTRY_CACHE_EXECUTOR);
