...
import com.jd.live.agent.plugin.registry.dubbo.v3.interceptor.NacosPropertiesInterceptor;

/**
 * NacosPropertiesDefinition
 */
@Extension(value = "NacosNamingServiceUtilsDefinition_v3", order = PluginDefinition.ORDER_REGISTRY)
