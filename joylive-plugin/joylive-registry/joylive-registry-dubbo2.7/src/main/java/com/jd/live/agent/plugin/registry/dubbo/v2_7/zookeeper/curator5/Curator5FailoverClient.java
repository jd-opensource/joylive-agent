 ...
 */
package com.jd.live.agent.plugin.registry.dubbo.v2_7.zookeeper.curator5;
 ...
 */
public class Curator5FailoverClient extends AbstractZookeeperClient<CuratorListener, CuratorListener> {

    private final CuratorFailoverClient client;

    public Curator5FailoverClient(URL url, Timer timer) {
        super(url);
    ...
    protected void addTargetDataListener(String path, CuratorListener listener) {
        addTargetDataListener(path, listener, null);
    }
