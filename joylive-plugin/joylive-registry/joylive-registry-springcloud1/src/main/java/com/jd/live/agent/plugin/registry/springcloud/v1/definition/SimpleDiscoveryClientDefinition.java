...
import com.jd.live.agent.plugin.registry.springcloud.v1.condition.ConditionalOnSpringCloud1RegistryEnabled;
import com.jd.live.agent.plugin.registry.springcloud.v1.interceptor.SimpleDiscoveryClientInterceptor;

/**
 * SimpleDiscoveryClientDefinition
 */
@Extension(value = "SimpleDiscoveryClientDefinition_v1")
@ConditionalOnSpringCloud1RegistryEnabled
