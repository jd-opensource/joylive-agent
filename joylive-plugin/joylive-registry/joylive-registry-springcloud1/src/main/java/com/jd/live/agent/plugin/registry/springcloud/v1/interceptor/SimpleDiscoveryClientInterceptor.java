 ...
 */
package com.jd.live.agent.plugin.registry.springcloud.v1.interceptor;
...
import com.jd.live.agent.plugin.registry.springcloud.v1.instance.SpringEndpoint;
import com.jd.live.agent.plugin.registry.springcloud.v1.registry.SimpleRegistryService;
...
public class SimpleDiscoveryClientInterceptor extends InterceptorAdaptor {
    ...
    public void onEnter(ExecutableContext ctx) {
        ...
        Map<String, List<SimpleServiceInstance>> simples = properties.getInstances();
        if (!simples.isEmpty()) {
