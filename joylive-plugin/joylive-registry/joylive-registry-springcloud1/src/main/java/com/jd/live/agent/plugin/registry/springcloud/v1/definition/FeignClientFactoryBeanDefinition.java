...
import com.jd.live.agent.plugin.registry.springcloud.v1.interceptor.FeignClientFactoryBeanInterceptor;

/**
 * FeignClientFactoryBeanDefinition
 */
@Injectable
@Extension(value = "FeignClientFactoryBeanDefinition_v1", order = PluginDefinition.ORDER_REGISTRY)
@ConditionalOnSpringCloud1GovernanceEnabled
@ConditionalOnClass(FeignClientFactoryBeanDefinition.TYPE)
public class FeignClientFactoryBeanDefinition extends PluginDefinitionAdapter {

    protected static final String TYPE = "org.springframework.cloud.netflix.feign.FeignClientFactoryBean";

    private static final String METHOD = "feign";
