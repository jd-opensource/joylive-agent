 ...
 */
package com.jd.live.agent.plugin.registry.springgateway.v2_2.definition;
...
import com.jd.live.agent.plugin.registry.springgateway.v2_2.condition.ConditionalOnSpringGateway2GovernanceEnabled;
import com.jd.live.agent.plugin.registry.springgateway.v2_2.interceptor.RouteInterceptor;

/**
 * RouteDefinition
 */
@Injectable
@Extension(value = "RouteDefinition_v2.2", order = PluginDefinition.ORDER_REGISTRY)
