...
import com.jd.live.agent.plugin.registry.springcloud.v3.interceptor.ServiceRegistryInterceptor;
...
public class ServiceRegistryDefinition extends PluginDefinitionAdapter {
    ...
    public ServiceRegistryDefinition() {
        ...
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        ...
                        () -> new ServiceRegistryInterceptor(application, policySupplier))
        };
    }
}
