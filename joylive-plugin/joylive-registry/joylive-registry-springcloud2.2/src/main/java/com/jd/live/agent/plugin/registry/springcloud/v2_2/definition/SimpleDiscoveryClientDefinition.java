...
import com.jd.live.agent.plugin.registry.springcloud.v2_2.interceptor.SimpleDiscoveryClientConstructorInterceptor;
import com.jd.live.agent.plugin.registry.springcloud.v2_2.interceptor.SimpleDiscoveryClientGetInstancesInterceptor;

/**
 * SimpleDiscoveryClientDefinition
 */
@Extension(value = "SimpleDiscoveryClientDefinition_v2.2")
