...
import com.jd.live.agent.plugin.registry.springcloud.v4.interceptor.FeignClientFactoryBeanInterceptor;

/**
 * FeignClientFactoryBeanDefinition
 */
@Injectable
@Extension(value = "FeignClientFactoryBeanDefinition_v4", order = PluginDefinition.ORDER_REGISTRY)
