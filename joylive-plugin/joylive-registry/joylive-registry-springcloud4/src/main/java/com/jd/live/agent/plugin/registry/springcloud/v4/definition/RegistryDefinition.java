...
import com.jd.live.agent.plugin.registry.springcloud.v4.interceptor.RegistryInterceptor;
 ...
 */
@Injectable
@Extension(value = "ServiceRegistryDefinition_v4", order = PluginDefinition.ORDER_REGISTRY)
