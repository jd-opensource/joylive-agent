...
public class NacosInstancesChangeNotifier extends InstancesChangeNotifier {
    ...
    public void registerListener(String serviceName, String clusters, EventListener listener) {
        notifier.registerListener(serviceName, clusters, listener);
    }

    @Override
    public void deregisterListener(String serviceName, String clusters, EventListener listener) {
        notifier.deregisterListener(serviceName, clusters, listener);
    }

    @Override
    public boolean isSubscribed(String serviceName, String clusters) {
        return notifier.isSubscribed(serviceName, clusters);
    }
