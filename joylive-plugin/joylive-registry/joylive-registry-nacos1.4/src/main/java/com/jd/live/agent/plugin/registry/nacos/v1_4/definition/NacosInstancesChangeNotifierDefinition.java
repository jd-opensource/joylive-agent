...
import com.jd.live.agent.plugin.registry.nacos.v1_4.interceptor.NacosInstancesChangeNotifierInterceptor;

/**
 * NacosInstanceChangeDefinition
 */
@Injectable
@Extension(value = "NacosInstanceChangeDefinition_v1.4", order = PluginDefinition.ORDER_REGISTRY)
