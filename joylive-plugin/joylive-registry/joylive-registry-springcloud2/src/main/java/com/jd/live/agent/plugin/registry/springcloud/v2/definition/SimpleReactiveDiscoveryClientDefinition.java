 ...
 */
package com.jd.live.agent.plugin.registry.springcloud.v2.definition;
...
import com.jd.live.agent.plugin.registry.springcloud.v2.condition.ConditionalOnSpringCloud2RegistryEnabled;
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.SimpleReactiveDiscoveryClientConstructorInterceptor;
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.SimpleReactiveDiscoveryClientGetInstancesInterceptor;

/**
 * SimpleReactiveDiscoveryClientDefinition
 */
@Extension(value = "SimpleReactiveDiscoveryClientDefinition_v2")
