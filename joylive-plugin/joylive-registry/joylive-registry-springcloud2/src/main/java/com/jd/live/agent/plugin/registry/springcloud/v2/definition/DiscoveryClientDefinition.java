...
import com.jd.live.agent.plugin.registry.springcloud.v2.condition.ConditionalOnSpringCloud2GovernanceEnabled;
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.DiscoveryClientConstructorInterceptor;
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.DiscoveryClientGetInterceptor;

/**
 * DiscoveryClientDefinition
 */
@Injectable
@Extension(value = "DiscoveryClientDefinition_v2", order = PluginDefinition.ORDER_REGISTRY)
