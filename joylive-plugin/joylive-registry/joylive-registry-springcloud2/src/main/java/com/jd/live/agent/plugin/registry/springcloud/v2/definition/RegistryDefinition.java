...
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.RegistryInterceptor;
 ...
 */
@Injectable
@Extension(value = "ServiceRegistryDefinition_v2", order = PluginDefinition.ORDER_REGISTRY)
