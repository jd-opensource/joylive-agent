...
import com.jd.live.agent.plugin.registry.springcloud.v2.interceptor.FeignClientFactoryBeanInterceptor;

/**
 * FeignClientFactoryBeanDefinition
 */
@Injectable
@Extension(value = "FeignClientFactoryBeanDefinition_v2", order = PluginDefinition.ORDER_REGISTRY)
