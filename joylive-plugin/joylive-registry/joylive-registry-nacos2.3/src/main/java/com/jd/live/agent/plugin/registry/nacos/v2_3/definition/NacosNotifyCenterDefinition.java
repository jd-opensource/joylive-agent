...
import com.jd.live.agent.plugin.registry.nacos.v2_3.interceptor.NacosNotifyCenterInterceptor;

/**
 * NotifyCenterDefinition
 */
@Injectable
@Extension(value = "NotifyCenterDefinition_v2.3", order = PluginDefinition.ORDER_REGISTRY)
