...
import com.jd.live.agent.plugin.router.springcloud.v2_2.cluster.FeignWebCluster;
...
import com.jd.live.agent.plugin.router.springcloud.v2_2.request.FeignWebOutboundRequest;
    ...
    public void onEnter(ExecutableContext ctx) {
        ...
        try {
            List<ServiceEndpoint> endpoints = registry.subscribeAndGet(service, 5000, (message, e) ->
                    new InternalServerError(message, request, request.body()));
