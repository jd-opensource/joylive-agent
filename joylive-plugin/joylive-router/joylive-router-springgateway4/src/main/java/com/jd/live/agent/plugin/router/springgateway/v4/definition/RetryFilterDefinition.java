...
import com.jd.live.agent.plugin.router.springgateway.v4.interceptor.RetryFilterInterceptor;
 ...
 * @since 1.6.0
 */
@Extension(value = "RetryFilterDefinition_v4")
...
@ConditionalOnClass(RetryFilterDefinition.TYPE_HTTP_STATUS_CODE)
@Injectable
