...
public class CloudUtils {
    ...
    private static final Class<?> CLASS_READ_ONLY_HTTP_HEADERS = loadClass("org.springframework.http.ReadOnlyHttpHeaders", HttpHeaders.class.getClassLoader());
    ...
    public static HttpHeaders writable(HttpHeaders headers) {
        return CLASS_READ_ONLY_HTTP_HEADERS.isInstance(headers) ? new HttpHeaders(headers) : headers;
    }
