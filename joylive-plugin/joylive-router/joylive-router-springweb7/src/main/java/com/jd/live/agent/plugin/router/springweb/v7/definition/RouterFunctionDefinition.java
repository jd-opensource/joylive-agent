...
import com.jd.live.agent.plugin.router.springweb.v7.interceptor.RouterFunctionInterceptor;
 ...
 */
@Injectable
@Extension(value = "RouterFunctionDefinition_v7")
    ...
    public RouterFunctionDefinition() {
        ...
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        MatcherBuilder.named(METHOD), () -> new RouterFunctionInterceptor(context)
                )
        };
    }
}
