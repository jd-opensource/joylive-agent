...
import com.jd.live.agent.plugin.router.springcloud.v4.interceptor.SimpleDiscoveryClientConstructorInterceptor;
import com.jd.live.agent.plugin.router.springcloud.v4.interceptor.SimpleDiscoveryClientGetInstancesInterceptor;

/**
 * SimpleDiscoveryClientDefinition
 */
@Extension(value = "SimpleDiscoveryClientDefinition_v4")
