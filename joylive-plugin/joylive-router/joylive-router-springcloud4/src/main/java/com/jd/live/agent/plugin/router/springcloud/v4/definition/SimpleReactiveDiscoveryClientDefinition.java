...
import com.jd.live.agent.plugin.router.springcloud.v4.condition.ConditionalOnSpringCloud4RegistryEnabled;
import com.jd.live.agent.plugin.router.springcloud.v4.interceptor.SimpleReactiveDiscoveryClientConstructorInterceptor;
import com.jd.live.agent.plugin.router.springcloud.v4.interceptor.SimpleReactiveDiscoveryClientGetInstancesInterceptor;

/**
 * SimpleReactiveDiscoveryClientDefinition
 */
@Extension(value = "SimpleReactiveDiscoveryClientDefinition_v4")
