 ...
 */
public class ReactiveOutboundRequest extends AbstractHttpOutboundRequest<ClientRequest> {

    private final String serviceId;

    private final HttpHeaders writeableHeaders;

    public ReactiveOutboundRequest(ClientRequest request, String serviceId) {
        super(request);
