 ...
 */
public class WebClientClusterRequest extends AbstractHttpOutboundRequest<ClientRequest> {
    ...
    public WebClientClusterRequest(ClientRequest request, String service, Registry registry, ExchangeFunction next) {
        super(request);
