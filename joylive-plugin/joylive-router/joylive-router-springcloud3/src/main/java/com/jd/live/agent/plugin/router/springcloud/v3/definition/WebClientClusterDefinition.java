...
import com.jd.live.agent.plugin.router.springcloud.v3.interceptor.WebClientClusterInterceptor;
...
@ConditionalOnClass(WebClientClusterDefinition.TYPE_DEFAULT_WEB_CLIENT)
public class WebClientClusterDefinition extends PluginDefinitionAdapter {
