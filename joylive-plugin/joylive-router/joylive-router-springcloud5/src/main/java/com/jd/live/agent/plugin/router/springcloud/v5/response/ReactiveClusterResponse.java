...
import com.jd.live.agent.plugin.router.springcloud.v5.request.DegradeHttpRequest;
...
public class ReactiveClusterResponse extends AbstractHttpOutboundResponse<ClientResponse> implements SpringClusterResponse {
    ...
    public String getCode() {
        HttpStatusCode status = response == null ? INTERNAL_SERVER_ERROR : response.statusCode();
