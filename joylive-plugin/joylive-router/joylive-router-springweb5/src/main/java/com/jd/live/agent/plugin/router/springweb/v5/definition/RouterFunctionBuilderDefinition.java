...
import com.jd.live.agent.plugin.router.springweb.v5.interceptor.RouterFunctionBuilderInterceptor;
 ...
 */
@Injectable
@Extension(value = "RouterFunctionBuilderDefinition_v5")
@ConditionalOnSpringWeb5GovernanceEnabled
@ConditionalOnClass(RouterFunctionBuilderDefinition.TYPE)
public class RouterFunctionBuilderDefinition extends PluginDefinitionAdapter {

    protected static final String TYPE = "org.springframework.web.servlet.function.RouterFunctionBuilder";

    private static final String METHOD = "build";

    public RouterFunctionBuilderDefinition() {
        this.matcher = () -> MatcherBuilder.isImplement(TYPE);
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        MatcherBuilder.named(METHOD), () -> new RouterFunctionBuilderInterceptor()
                )
        };
    }
}
