...
import com.jd.live.agent.plugin.router.springweb.v5.interceptor.HierarchicalUriComponentsInterceptor;

/**
 * HierarchicalUriComponentsDefinition
 */
@Extension(value = "HierarchicalUriComponentsDefinition_v5")
