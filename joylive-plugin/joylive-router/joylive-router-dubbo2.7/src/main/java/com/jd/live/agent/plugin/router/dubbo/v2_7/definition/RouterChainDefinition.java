...
import com.jd.live.agent.plugin.router.dubbo.v2_7.interceptor.RouterChainInterceptor;
...
@ConditionalOnClass(RouterChainDefinition.TYPE_ROUTER_CHAIN)
@ConditionalOnClass(ClassLoaderFilterDefinition.TYPE_PROTOCOL_FILTER_WRAPPER)
public class RouterChainDefinition extends PluginDefinitionAdapter {

    protected static final String TYPE_ROUTER_CHAIN = "org.apache.dubbo.rpc.cluster.RouterChain";
    ...
    public RouterChainDefinition() {
        ...
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        ...
                        () -> new RouterChainInterceptor(context, routeFilters)
                )
        };
    }
}
