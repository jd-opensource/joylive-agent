 ...
 */
package com.jd.live.agent.plugin.router.zuul.condition;
...
@ConditionalOnProperty(value = GovernanceConfig.CONFIG_GOVERN_ZUUL_ENABLED, matchIfMissing = true)
@ConditionalOnClass(ConditionalOnZuulEnabled.TYPE_ZUUL_CONTROLLER)
@ConditionalOnClass(ConditionalOnZuulEnabled.TYPE_ZUUL_SERVLET)
...
public @interface ConditionalOnZuulEnabled {
    ...
    String TYPE_ZUUL_CONTROLLER = "org.springframework.cloud.netflix.zuul.web.ZuulController";
