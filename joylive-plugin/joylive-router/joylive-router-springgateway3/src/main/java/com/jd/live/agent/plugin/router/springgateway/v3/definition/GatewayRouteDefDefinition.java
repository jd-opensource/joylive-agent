...
import com.jd.live.agent.plugin.router.springgateway.v3.condition.ConditionalOnSpringGateway3GovernanceEnabled;
import com.jd.live.agent.plugin.router.springgateway.v3.interceptor.GatewayRouteDefInterceptor;

/**
 * GatewayRouteDefDefinition
 */
@Extension(value = "GatewayRouteDefDefinition_v3")
