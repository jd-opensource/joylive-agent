...
import com.jd.live.agent.plugin.router.springgateway.v2_1.condition.ConditionalOnSpringGateway2GovernanceEnabled;
import com.jd.live.agent.plugin.router.springgateway.v2_1.interceptor.GatewayRouteDefInterceptor;

/**
 * GatewayRouteDefDefinition
 */
@Extension(value = "GatewayRouteDefDefinition_v2.1")
