...
import com.jd.live.agent.plugin.router.rocketmq.v5.interceptor.ConstructorInterceptor;
        ...
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        MatcherBuilder.isConstructor().
                                and(MatcherBuilder.arguments(ARGUMENT_CONSTRUCTOR)),
                        () -> new ConstructorInterceptor(context, liveEnabled, laneEnabled)
                ),
                new InterceptorDefinitionAdapter(
