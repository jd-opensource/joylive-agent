...
import com.jd.live.agent.plugin.router.springweb.v6.interceptor.ExceptionCarryingWebFluxInterceptor;

/**
 * @author Axkea
 */
@Injectable
@Extension(value = "ExceptionCarryingWebFluxDefinition_v6")
