...
import com.jd.live.agent.plugin.router.springweb.v6.interceptor.InvocableHandlerInterceptor;
 ...
 */
@Injectable
@Extension(value = "InvocableHandlerDefinition_v6")
    ...
    public InvocableHandlerDefinition() {
        ...
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(
                        MatcherBuilder.named(METHOD), () -> new InvocableHandlerInterceptor(context)
                )
        };
    }
}
