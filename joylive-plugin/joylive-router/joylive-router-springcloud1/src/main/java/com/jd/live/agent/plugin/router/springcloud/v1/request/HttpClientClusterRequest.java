...
import static com.jd.live.agent.plugin.router.springcloud.v1.instance.EndpointInstance.convert;
...
public class HttpClientClusterRequest extends AbstractCloudClusterRequest<HttpRequest, HttpClientClusterContext> {
     ...
     */
    public HttpResponse execute(ServiceEndpoint endpoint) throws IOException {
