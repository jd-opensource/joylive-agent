...
public class FeignClusterContext extends AbstractCloudClusterContext {
    ...
    public FeignClusterContext(Registry registry, LoadBalancerFeignClient client) {
        ...
        this.retryFactory = (LoadBalancedRetryPolicyFactory) Accessor.loadBalancedRetryPolicyFactory.get(Accessor.lbClientFactory.get(client));
    ...
    private static final class Accessor {
        ...
        private static final FieldAccessor loadBalancedRetryPolicyFactory = getAccessor(CachingSpringLoadBalancerFactory.class, "loadBalancedRetryPolicyFactory");
