 ...
 */
package com.jd.live.agent.plugin.router.springcloud.v1.exception.feign;
...
public class FeignThrower extends SpringOutboundThrower<FeignException, FeignOutboundRequest> {
    ...
    public static final FeignThrowerFactory<FeignOutboundRequest> FACTORY = new FeignThrowerFactory<>();

    public static final FeignThrower INSTANCE = new FeignThrower(FACTORY);
