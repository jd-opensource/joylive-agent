 ...
 * @since 1.9.0
 */
@Extension(value = "LoadBalancerInterceptorDefinition_v1")
@ConditionalOnSpringCloud1OnlyRouteEnabled
@ConditionalOnClass(LoadBalancerInterceptorDefinition.TYPE_LOAD_BALANCER_INTERCEPTOR)
public class LoadBalancerInterceptorDefinition extends PluginDefinitionAdapter {

    // for RestTemplate
    protected static final String TYPE_RETRY_LOAD_BALANCER_INTERCEPTOR = "org.springframework.cloud.client.loadbalancer.RetryLoadBalancerInterceptor";
    // for RestTemplate
    protected static final String TYPE_LOAD_BALANCER_INTERCEPTOR = "org.springframework.cloud.client.loadbalancer.LoadBalancerInterceptor";
