...
import com.jd.live.agent.plugin.failover.lettuce.v6.connection.LettuceStatefulRedisPubSubConnection;
...
/**
 * ConnectPubSubAsyncInterceptor
 */
public class ConnectPubSubAsyncInterceptor extends AbstractLettuceInterceptor {

    private static final Logger logger = LoggerFactory.getLogger(ConnectPubSubAsyncInterceptor.class);

    public ConnectPubSubAsyncInterceptor(InvocationContext context) {
    ...
    public void onEnter(ExecutableContext ctx) {
        ...
        DbCandidate candidate = connectionSupervisor.getCandidate(TYPE_REDIS, UriUtils.getAddress(uri), getAccessMode(uri.getClientName()), addressResolver);
    ...
    public void onSuccess(ExecutableContext ctx) {
        ...
        ConnectionFuture<LettuceStatefulRedisPubSubConnection<?, ?>> future = mc.getResult();
    ...
    private static class Accessor {
        ...
        private static final Method connect = ClassUtils.getDeclaredMethod(RedisClient.class,
                "connectPubSubAsync", new Class[]{RedisCodec.class, RedisURI.class, Duration.class});
