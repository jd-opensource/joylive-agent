...
@Injectable
@Extension(value = "SentinelTopologyDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
...
public class SentinelTopologyDefinition extends PluginDefinitionAdapter {
    ...
    public SentinelTopologyDefinition() {
        this.matcher = () -> MatcherBuilder.named(TYPE);
        this.interceptors = new InterceptorDefinition[]{
                new InterceptorDefinitionAdapter(MatcherBuilder.named(METHOD), () -> new IgnoreSentinelInterceptor()),
        };
    }
}
