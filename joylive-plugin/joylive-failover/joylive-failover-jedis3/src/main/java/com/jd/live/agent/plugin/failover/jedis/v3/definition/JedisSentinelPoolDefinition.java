...
import com.jd.live.agent.plugin.failover.jedis.v3.interceptor.JedisSentinelPoolInterceptor;

@Injectable
@Extension(value = "JedisSentinelPoolDefinition_v3", order = PluginDefinition.ORDER_FAILOVER)
