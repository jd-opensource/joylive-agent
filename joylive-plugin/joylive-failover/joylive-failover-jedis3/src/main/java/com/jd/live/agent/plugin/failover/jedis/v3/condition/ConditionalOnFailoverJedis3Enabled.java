 ...
 */
package com.jd.live.agent.plugin.failover.jedis.v3.condition;
...
@ConditionalOnClass(ConditionalOnFailoverJedis3Enabled.TYPE_HOST_AND_PORT)
@ConditionalOnMissingClass(ConditionalOnFailoverJedis3Enabled.TYPE_GEO_UNIT)
@ConditionalComposite
public @interface ConditionalOnFailoverJedis3Enabled {
