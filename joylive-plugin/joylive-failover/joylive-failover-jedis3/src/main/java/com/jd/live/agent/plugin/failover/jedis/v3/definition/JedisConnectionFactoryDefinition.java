...
import com.jd.live.agent.plugin.failover.jedis.v3.interceptor.JedisSpringCreateConfigInterceptor;
import com.jd.live.agent.plugin.failover.jedis.v3.interceptor.JedisSpringGetConnectionInterceptor;

@Injectable
@Extension(value = "JedisSpringConnectionDefinition_v3", order = PluginDefinition.ORDER_FAILOVER)
