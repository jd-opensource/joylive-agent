...
import com.jd.live.agent.plugin.failover.jedis.v6.interceptor.JedisPoolInterceptor;

@Injectable
@Extension(value = "JedisPoolDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
