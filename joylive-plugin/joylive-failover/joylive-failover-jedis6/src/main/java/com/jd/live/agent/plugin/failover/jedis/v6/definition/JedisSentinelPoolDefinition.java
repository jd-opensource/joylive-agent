...
import com.jd.live.agent.plugin.failover.jedis.v6.interceptor.JedisSentinelPoolInterceptor;

@Injectable
@Extension(value = "JedisSentinelPoolDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
