...
import com.jd.live.agent.plugin.failover.jedis.v6.interceptor.JedisClusterInterceptor;

@Injectable
@Extension(value = "JedisClusterDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
