 ...
 */
package com.jd.live.agent.plugin.failover.jedis.v6.definition;
...
import com.jd.live.agent.plugin.failover.jedis.v6.condition.ConditionalOnFailoverJedis6Enabled;
import com.jd.live.agent.plugin.failover.jedis.v6.interceptor.JedisSpringCreateConfigInterceptor;
import com.jd.live.agent.plugin.failover.jedis.v6.interceptor.JedisSpringGetConnectionInterceptor;

@Injectable
@Extension(value = "JedisSpringConnectionDefinition_v6", order = PluginDefinition.ORDER_FAILOVER)
@ConditionalOnFailoverJedis6Enabled
