...
import com.jd.live.agent.plugin.failover.jedis.v4.interceptor.JedisSentinelPoolInterceptor;

@Injectable
@Extension(value = "JedisSentinelPoolDefinition_v4", order = PluginDefinition.ORDER_FAILOVER)
