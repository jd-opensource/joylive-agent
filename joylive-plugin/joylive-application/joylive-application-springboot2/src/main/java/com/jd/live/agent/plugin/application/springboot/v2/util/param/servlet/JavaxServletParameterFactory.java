 ...
 */
public class JavaxServletParameterFactory extends ServletParameterFactory implements SystemParameterFactory {
    ...
    private static final String TYPE_JAVAX_HTTP_SESSION = "javax.servlet.http.HttpSession";
    ...
    private static final String TYPE_JAVAX_COOKIE = "javax.servlet.http.Cookie";
    private static final Class<?> CLASS_JAVAX_COOKIE = loadClass(TYPE_JAVAX_COOKIE, ResourceLoader.class.getClassLoader());
    private static final FieldAccessor ACCESSOR_COOKE_VALUE = getAccessor(CLASS_JAVAX_COOKIE, "value");
    ...
    private Object getRequest() {
        return getWebRequest(CLASS_JAVAX_HTTP_SERVLET_REQUEST);
    }

    private Object getResponse() {
        return getWebResponse(CLASS_JAVAX_HTTP_SERVLET_RESPONSE);
    }
