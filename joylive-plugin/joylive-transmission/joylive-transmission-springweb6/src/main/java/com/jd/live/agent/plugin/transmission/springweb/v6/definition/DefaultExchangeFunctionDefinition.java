...
import com.jd.live.agent.plugin.transmission.springweb.v6.interceptor.DefaultExchangeFunctionInterceptor;
 ...
 */
@Injectable
@Extension(value = "DefaultExchangeFunctionDefinition_v6", order = PluginDefinition.ORDER_TRANSMISSION)
