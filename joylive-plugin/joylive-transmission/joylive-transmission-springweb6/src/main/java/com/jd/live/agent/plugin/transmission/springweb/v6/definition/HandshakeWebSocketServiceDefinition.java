...
import com.jd.live.agent.plugin.transmission.springweb.v6.interceptor.HandshakeWebSocketServiceInterceptor;
 ...
 */
@Injectable
@Extension(value = "HandshakeWebSocketServiceDefinition_v6", order = PluginDefinition.ORDER_TRANSMISSION)
