...
import com.jd.live.agent.plugin.transmission.springweb.v7.interceptor.DefaultExchangeFunctionInterceptor;
 ...
 */
@Injectable
@Extension(value = "DefaultExchangeFunctionDefinition_v7", order = PluginDefinition.ORDER_TRANSMISSION)
