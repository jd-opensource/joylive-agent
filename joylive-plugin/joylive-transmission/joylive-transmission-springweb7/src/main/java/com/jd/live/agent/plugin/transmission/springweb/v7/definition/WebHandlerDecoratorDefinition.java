...
import com.jd.live.agent.plugin.transmission.springweb.v7.interceptor.WebHandlerDecoratorInterceptor;
 ...
 */
@Injectable
@Extension(value = "WebHandlerDecoratorDefinition_v7", order = PluginDefinition.ORDER_TRANSMISSION)
