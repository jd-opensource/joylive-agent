...
public class BuilderWriter implements HeaderWriter {
    ...
    /**
     * Creates a new instance of {@link BuilderWriter} using the names and values from the given {@link Request.Builder}.
     *
    ...
    public static BuilderWriter of(Request.Builder builder) {
        return new BuilderWriter((List<String>) path.get(builder, ArrayList::new));
    }
