...
@Injectable
@Extension(value = "AutoRetryHttpClientDefinition_v4.3", order = PluginDefinition.ORDER_TRANSMISSION)
...
public class HttpClientDefinition extends PluginDefinitionAdapter {
    ...
    public HttpClientDefinition() {
        this.matcher = () -> MatcherBuilder.in(TYPE_AUTO_RETRY_HTTP_CLIENT, TYPE_DECOMPRESSING_HTTP_CLIENT);
