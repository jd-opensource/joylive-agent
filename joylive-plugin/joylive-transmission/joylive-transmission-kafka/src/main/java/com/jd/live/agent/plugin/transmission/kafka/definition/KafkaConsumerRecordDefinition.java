 ...
 */
package com.jd.live.agent.plugin.transmission.kafka.definition;
...
import com.jd.live.agent.plugin.transmission.kafka.interceptor.KafkaConsumerRecordInterceptor;

import java.util.List;

@Injectable
@Extension(value = "KafkaConsumerRecordDefinition", order = PluginDefinition.ORDER_TRANSMISSION)
