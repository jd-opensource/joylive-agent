...
import com.jd.live.agent.plugin.transmission.kafka.interceptor.KafkaProducerInterceptor;

@Extension(value = "KafkaProducerDefinition", order = PluginDefinition.ORDER_TRANSMISSION)
